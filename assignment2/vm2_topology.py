...
def createTopology():
    ...
    # Dynamically get the interface names for rP and rQ
    # This will get the names of the first Ethernet interface on each router
    rP_interface_name = rP.intfNames()[0]  # This assumes rP-eth0 is the first interface
    rQ_interface_name = rQ.intfNames()[0]  # This assumes rQ-eth0 is the first interface
